...
if config.mode == "train":
    ...
    model = CatDogPredictor(model_path=load_path,
                            flag="scratch",
    ...
    model.train_model(train_loader, val_loader, learning_rate=config.learning_rate,
                      ...
                      show_batch=3, model_save_path=model_save_name)
    ...
    model.val_logger.info(f"test result: " + f"accuracy={metric_test['accuracy']:.3f}, precision={metric_test['precision']:.3f}" \
